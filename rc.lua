...
awful.spawn.once("playerctld daemon") -- Monitor which apps are currently playing
-- }}}
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey,           }, "s",
              function ()
                awful.util.spawn_with_shell("~/workspace/software/rofi-scripts/monitor_layout.sh")
              end,
              {description = "Choose screen", group = "Application"}),
