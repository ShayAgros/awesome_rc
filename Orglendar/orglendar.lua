...
local orglendar = { files = { "/home/ANT.AMAZON.COM/shayagr/todo.org" },
                    char_width = nil,
...
function orglendar.parse_agenda()
   ...
   local task_name
	...
	--spawn.easy_async_with_shell("emacs --batch --eval '(progn (load \"~/.emacs.d/lisp/init-org.el\") (parse_todo_in_org \"/tmp/test.org\"))'",
		--function(stdout, stderr, exitreason, exitcode)
			
			--table.insert(data.tasks, { name = "hello",
									   --tags = "bye",
									   --date = "",
									   --recur = nil})
		--end
	--)
   --for _, file in ipairs(orglendar.files) do
